...
const events = [
    { name: "Buzz", datetime: new Date("2026-05-26T17:15:00") },
    { name: "Haircut", datetime: new Date("2026-06-16T13:00:00") },
    { name: "Buzz", datetime: new Date("2026-06-30T19:30:00") }
];
...
function formatCountdown(eventDate) {
    ...
    // More than 2 days away: show days only (rounded to nearest)
    if (totalHours > TWO_DAYS_IN_HOURS) {
        const remainingHours = totalHours % 24;
        const daysRounded = remainingHours >= 12 ? totalDays + 1 : totalDays;
